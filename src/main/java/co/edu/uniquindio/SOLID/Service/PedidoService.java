...
import co.edu.uniquindio.SOLID.Service.Descuento.GestorDescuento;
...
public class PedidoService {
    ...
    private final GestorDescuento gestorDescuento; //-> Para refactorización de strategy
    ...
    public PedidoService(CatalogoProductosService catalogoProductosService) {
        ...
        this.gestorDescuento = new GestorDescuento();
    }
    ...
    //Se refactoriza el metodo para utilizar con el patrón strategy -> Taller
    public double calcularTotal(Pedido pedido, Envio envio) {
        ...
        double descuento= gestorDescuento.aplicaDescuento(subtotal,pedido);
